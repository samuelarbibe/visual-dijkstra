...
declare class p5 {
  ...
  /**
   *   Calculates the dist between two points.
   *
   *   @param x1 x-coordinate of the first point
   *   @param y1 y-coordinate of the first point
   *   @param x2 x-coordinate of the second point
   *   @param y2 y-coordinate of the second point
   *   @return dist between the two points
   */
   ...
   *   can be thought of as the dist from the 
   ...
   *   doesn't matter as such, only the dist between 
   ...
   *   current size. The ascent represents the dist, 
   ...
   *   current size. The descent represents the dist, 
...
declare namespace p5 {
  ...
  class Vector {
    ...
    /**
     *   Calculates the Euclidean dist between two 
  ...
  class Panner3D {
     ...
     *   - <a title="w3 spec for dist Model" 
     *   href="https://www.w3.org/TR/webaudio/#idl-def-distModelType" 
     *   distModel: "linear", "inverse", or 
     *   "exponential"
     *
     */
    panner: AudioNode
    ...
    /**
     *   Set the rolloff factor and max dist
     *
     */
    setFalloff(maxdist?: number, rolloffFactor?: number): void
    
    /**
     *   Maxium dist between the source and the 
     *   listener
     *
     *   @return updated value
     */
    maxDist(maxdist: number): number
