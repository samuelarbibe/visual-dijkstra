...
panner3d = function () {
  ...
  p5.Panner3D = function () {
     ...
     *    >distModel</a>: "linear", "inverse", or "exponential"
     *
   ...
   */
  p5.Panner3D.prototype.setFalloff = function (maxdist, rolloffFactor) {
    this.maxDist(maxdist);
    this.rolloff(rolloffFactor);
  };
  /**
   * Maxium dist between the source and the listener
   * @method  maxDist
   * @param  {Number} maxdist
   * @return {Number} updated value
   */
  p5.Panner3D.prototype.maxDist = function (maxdist) {
    if (typeof maxdist === 'number') {
      this.panner.maxdist = maxdist;
    }
    return this.panner.maxdist;
  };
  /**
...
listener3d = function () {
  ...
  //   * @param {AudioParam} listener.distModel "linear", "inverse", or "exponential"
...
gain = function () {
   ...
   *   background(180);
   *
   *   // calculate the horizontal dist beetween the mouse and the right of the screen
